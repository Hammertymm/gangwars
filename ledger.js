...
const LEDGER_CATEGORIES = [
  ...
  },
  {
    ...
    achievements: [
      { id: 'pasta_la_vista', title: 'PASTA LA VISTA', description: 'Little Italy charges danger money.' },
      { id: 'gnocchi_horror_show', title: 'GNOCCHI HORROR SHOW', description: 'A bad batch sends Little Italy prices bouncing.' },
      { id: 'ship_happens', title: 'SHIP HAPPENS', description: 'Dock #13 turns manifest trouble into profit.' },
      { id: 'titanic_markup', title: 'TITANIC MARKUP', description: 'Titanic headlines haunt the piers.' },
      { id: 'jazz_stinger', title: 'THE JAZZ STINGER', description: 'The Kitty Kat Club triples the noise.' },
      { id: 'great_gats_got', title: 'THE GREAT GATS GOT', description: 'Gatsby fever hits the club.' },
      { id: 'dow_jonesing', title: 'DOW JONESING', description: 'Uptown prices triple on confidence alone.' },
      { id: 'margin_of_terror', title: 'MARGIN OF TERROR', description: 'Brokers smell fear in Uptown.' },
      { id: 'bribe_and_prejudice', title: 'BRIBE AND PREJUDICE', description: 'A reform hearing becomes a bidding war.' },
      { id: 'license_to_ill', title: 'LICENSE TO ILL', description: 'City Hall invents new permits by lunchtime.' },
      { id: 'pallet_wounds', title: 'PALLET WOUNDS', description: 'Warehouse crates start costing hush money.' },
      { id: 'crate_expectations', title: 'CRATE EXPECTATIONS', description: 'The Warehouse signs for stolen trouble.' },
    ],
  },
  {
    id: 'superRare',
